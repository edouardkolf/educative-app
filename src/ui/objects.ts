...
export const OBJECTS: readonly ObjectDef[] = [
  ...
  { id: 'cow', emoji: '🐄', category: 'animal', label: 'vache' },
  { id: 'pig', emoji: '🐷', category: 'animal', label: 'cochon' },
  { id: 'sheep', emoji: '🐑', category: 'animal', label: 'mouton' },
  { id: 'chicken', emoji: '🐔', category: 'animal', label: 'poule' },
  { id: 'horse', emoji: '🐴', category: 'animal', label: 'cheval' },
  { id: 'crab', emoji: '🦀', category: 'animal', label: 'crabe' },
  { id: 'octopus', emoji: '🐙', category: 'animal', label: 'pieuvre' },
  { id: 'whale', emoji: '🐳', category: 'animal', label: 'baleine' },
  { id: 'dolphin', emoji: '🐬', category: 'animal', label: 'dauphin' },
  { id: 'tropical-fish', emoji: '🐠', category: 'animal', label: 'poisson-clown' },
  { id: 'butterfly', emoji: '🦋', category: 'animal', label: 'papillon' },
  { id: 'bee', emoji: '🐝', category: 'animal', label: 'abeille' },
  { id: 'owl', emoji: '🦉', category: 'animal', label: 'hibou' },
